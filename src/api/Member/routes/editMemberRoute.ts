...
export default function editMemberRoute() {
   ...
   *   post:
   *     tags: [Members]
   *     summary: Update member profile with vendor details
   *     description: Update a member's profile information including vendor-specific details for the Vimbiso Market.
   *     security:
   *       - bearerAuth: []
   *     requestBody:
   *       required: true
   ...
   *                 description: Unique handle for the member (lowercase letters, numbers, underscores)
   *               vendorBio:
   *                 type: string
   *                 maxLength: 500
   *                 description: Vendor biography and description for marketplace
   *     responses:
   *       200:
   ...
   *                             memberHandle:
   *                               type: string
   *                               description: Updated member handle
   *                             vendorBio:
   *                               type: string
   *                               description: Updated vendor biography
   *                     dashboard:
   *                       type: object
   ...
   *                 message:
   *                   type: string
   *                   example: Not authorized to update this member
   *                 data:
   *                   type: object
   *                   properties:
   *                     action:
   ...
   *                       description: Empty dashboard object
   *       409:
   *         description: Member handle already exists
   *         content:
   *           application/json:
   *             schema:
   *               type: object
   ...
   *                 message:
   *                   type: string
   *                   example: Member handle is already in use
   *                 data:
   *                   type: object
   *                   properties:
   *                     action:
   ...
   *                 message:
   *                   type: string
   *                   example: Internal server error while updating member
   *                 data:
   *                   type: object
   *                   properties:
   *                     action:
