...
export async function UpdateAccountService(
  ...
  logger.debug("UpdateAccountService called", { ownerID, accountID, accountName, accountHandle, defaultDenom });
  ...
  try {
    logger.debug("Executing database query to update account", { ownerID, accountID });
