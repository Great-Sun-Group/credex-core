...
export default function cancelCredexRoute() {
   ...
   *                           type: string
   *                           format: uuid
   *                           description: The credexID of the cancelled transaction
   *                         type:
   *                           type: string
   *                           enum: [CREDEX_CANCELLED]
   ...
   *                 message:
   *                   type: string
   *                   example: "Cannot cancel Credex: invalid state"
   ...
   *                 message:
   *                   type: string
   *                   example: "Not authorized to cancel this Credex"
   *                 data:
   *                   type: object
   *                   properties:
   *                     action:
