...
resource "aws_s3_bucket" "verification_photos" {
  bucket = "credexbuckets4-verifybucket-photos-${var.environment}"
...
resource "aws_s3_bucket" "verification_logs" {
  bucket = "credexbuckets4-verifybucket-logs-${var.environment}"
...
resource "aws_s3_bucket" "verification_backups" {
  bucket   = "credexbuckets4-verifybucket-backups-${var.environment}"
...
resource "aws_s3_bucket" "asset_marker_data" {
  bucket = "credexbuckets4-assetmarker-data-${var.environment}"
...
resource "aws_s3_bucket" "infrastructure_scripts" {
  bucket = "credexbuckets4-scripts-${var.environment}"
