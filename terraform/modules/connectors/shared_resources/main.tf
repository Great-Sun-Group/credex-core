...
resource "aws_s3_bucket" "verification_photos" {
  bucket = "credexbuckets6-verifybucket-photos-${var.environment}"
...
resource "aws_s3_bucket" "verification_logs" {
  bucket = "credexbuckets6-verifybucket-logs-${var.environment}"
...
resource "aws_s3_bucket" "verification_backups" {
  bucket   = "credexbuckets6-verifybucket-backups-${var.environment}"
...
resource "aws_s3_bucket" "asset_marker_data" {
  bucket = "credexbuckets6-assetmarker-data-${var.environment}"
