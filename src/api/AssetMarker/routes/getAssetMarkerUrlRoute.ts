 ...
 *                     url:
 *                       type: string
 *                       example: https://credexbuckets6-assetmarker-data-development.s3.af-south-1.amazonaws.com/123/original/image.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=...
 *                     assetID:
 *                       type: string
