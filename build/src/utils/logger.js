...
exports.logDCORates = exports.errorLogger = exports.expressLogger = exports.addRequestId = exports.logDebug = exports.logWarning = exports.logError = exports.logInfo = void 0;
...
const expressLogger = (req, res, next) => {
    ...
    res.on("finish", () => {
        ...
        (0, exports.logInfo)("HTTP Request", {
            requestId: req.id,
            method: req.method,
            url: req.originalUrl,
...
const errorLogger = (err, req, res, next) => {
    (0, exports.logError)("Request Error", err, {
        requestId: req.id,
        method: req.method,
        url: req.originalUrl,
        body: sanitizeData(req.body),
...
const logDCORates = (XAUrate, CXXrate, CXXmultiplier) => {
    (0, exports.logInfo)("DCO Rates", { XAUrate, CXXrate, CXXmultiplier });
};
