...
resource "aws_s3_bucket" "verification_photos" {
  bucket = "credexbuckets5-verifybucket-photos-${var.environment}"
...
resource "aws_s3_bucket" "verification_logs" {
  bucket = "credexbuckets5-verifybucket-logs-${var.environment}"
...
resource "aws_s3_bucket" "verification_backups" {
  bucket   = "credexbuckets5-verifybucket-backups-${var.environment}"
...
resource "aws_s3_bucket" "asset_marker_data" {
  bucket = "credexbuckets5-assetmarker-data-${var.environment}"
...
resource "aws_s3_bucket" "infrastructure_scripts" {
  bucket = "credexbuckets5-scripts-${var.environment}"
